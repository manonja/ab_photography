...
// const images = await get7RadImages();
  ...
  return (
      <>
        ...
        <Link  
          className="flex flex-col w-full items-end sm:pt-4 text-xs text-gray-300  hover:text-orange-600"
          href="https://github.com/pyalanysis/pyalanysis"> 
          Python Package 
        </Link>
        <Link  
          className="flex flex-col w-full items-end sm:pt-2 text-xs text-gray-300 hover:text-orange-600"
